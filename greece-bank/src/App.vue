<template>
  <div class="hero">
    <a href="https://ebanking.eurobank.gr/#/login" class="reload-button">
      <p>GREECE BANK</p>
...
import { setupApp } from './AppScript.js'

// Setup the reactive state
const { languages } = setupApp()
</script>

<style src="./AppStyle.css" scoped></style>
